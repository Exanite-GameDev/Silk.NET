<h1 align="center">⚠️ This is a fork of Silk.NET v3 ⚠️</h1>

This is a fork of Silk.NET v3 for use by Exanite.Engine. While changes to this repo will still be under the same license
