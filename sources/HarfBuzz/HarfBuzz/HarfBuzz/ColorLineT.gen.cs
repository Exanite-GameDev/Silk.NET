...
[NativeName("hb_color_line_t")]
public unsafe partial struct ColorLineT
{
    [NativeName("data")]
    public void* Data;

    [NativeName("get_color_stops")]
    public ColorLineGetColorStopsFuncT GetColorStops;

    [NativeName("get_color_stops_user_data")]
    public void* GetColorStopsUserData;

    [NativeName("get_extend")]
    public ColorLineGetExtendFuncT GetExtend;

    [NativeName("get_extend_user_data")]
    public void* GetExtendUserData;

    [NativeName("reserved0")]
